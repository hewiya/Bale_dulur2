	...
	<div id="adah">
		...
		<div id="bg"></div>
				<div id="modal-kotak">   <!--    sumthing      -->
					<div id="atas">
					<form name="login" action="<?php echo base_url('index.php/login/aksi_login'); ?>" method="POST">
				<table width="281" height="90">
				<center><img src="<?php echo base_url() ?>assets/images/templatemo_logo.png" alt="" width="300px"/><br/><br/><br/>Pengguna, silahkan 'Sign In' untuk melanjutkan<br/></center>
					<tr>
						<td>Email</td>
						<td>:</td>
				...
				//javascript buat nambah pop up untuk sign in & sign up
		...
		<div id="bg"></div>
				<div id="modal-kotakdaftar">
					<div id="atas">
					<form name="daftar" action="<?php echo base_url('index.php/user/tambah_aksi'); ?>" method="POST">
				<table width="281" height="90">
					<center><img src="<?php echo base_url() ?>assets/images/templatemo_logo.png" alt="" width="300px"/><br/><br/><br/>Pengguna, silahkan 'Sign Up' untuk melanjutkan<br/></center>
					<tr>
						<td>First Name</td>
						<td>:</td>
	...
	<script src="<?php echo base_url() ?>assets/js/jquery.min.js"></script>
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                // Call Gridder
				// Gridder buat jQuery untuk button sign-up,sign-in,cari ada efek geser nya gitu
