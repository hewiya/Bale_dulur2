...
<br>
           <ul class="gridder">
			   <?php
						$hasil=mysql_query ('select * from rumah');					
						$i=1;
						...
						echo '			<img src="admin/upload/'.$foto['foto'].'" class="img-responsive"/>
										<div class="tls"><center>'.$r['nama_rumah'].'<br/>IDR '.$r['harga'].'</center></div>
