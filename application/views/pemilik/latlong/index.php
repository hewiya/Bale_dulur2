...
<div class="tumpang2">
	...
	<center>
	<form action="<?php echo base_url('index.php/controler/simpanlokasi'); ?>" method="GET">
	<h1>INPUT LOKASI</h1>
	...
	<input type=hidden name=jenis onclick="setjenis(this.value)"><br>
	   <input type=hidden name=id value="<?php echo $this->session->userdata("nama"); ?><?php//=$_SESSION['id']?>"><br>
	   <p>
